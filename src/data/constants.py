...
keep_columns_app_py = ['ANSWER_num_rooms',
'POSITION',
'clusers',
'CITYMARKET',
'PROPERTY_NAME',
...
# In the future create a survey that has this type of validation on the front end.
exec_jobs = ['Director', 'Manager', 'Controller',
             'Account', 'Executive', 'Purchasing', 'Supervisor']
